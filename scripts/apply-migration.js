#!/usr/bin/env node
// apply-migration.js
// Usage: node scripts/apply-migration.js path/to/migration.sql [DATABASE_URL]
...
async function main(){
  ...
  if(!sqlPath){
    console.error('Usage: node scripts/apply-migration.js path/to/migration.sql [DATABASE_URL]');
    process.exit(2);
  }
